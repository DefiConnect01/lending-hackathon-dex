...
import { formatBN, removeDuplicate } from '../../lib/utils';
import { getLocalAssets } from "./local-storage-helper";
import { createClient } from "urql";

// const client = createClient({ url: import.meta.env.VITE_PUBLIC_API });
...
async function getTokenList() {
  if (parseInt(import.meta.env.VITE_PUBLIC_CHAINID) === 50002) {
